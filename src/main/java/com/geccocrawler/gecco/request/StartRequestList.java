...
public class StartRequestList {
	...
	private Map<String, String> custom_param;
	
	public StartRequestList() {
		cookies = new HashMap<String, String>();
		headers = new HashMap<String, String>();
		posts = new HashMap<String, String>();
		custom_param = new HashMap<String, String>();
	}
	...
	public HttpRequest toRequest() {
		if(posts != null && posts.size() > 0) {
			...
			post.setParameters(custom_param);
			return post;
		} else {
			...
			get.setParameters(custom_param);
			return get;
		}
	}
	...
	public Map<String, String> getCustom_param() {
		return custom_param;
	}

	public void setCustom_param(Map<String, String> custom_param) {
