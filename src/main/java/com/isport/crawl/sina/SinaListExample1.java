 ...
 * 2.发布时间规则："(2018-11-21 14:03:45)"
 * 3.翻页规则：从第1页开始，页码格式为“{filename}_{page}.{suffix}”
 * 
 */
@Service
public class SinaListExample1 extends AbstractListPipeLine {

	private static final Logger LOGGER = LoggerFactory.getLogger(SinaListExample1.class);
	...
	protected long getNewsTime(Object obj) throws Exception {
		...
		try {
			...
			strPubDate = strPubDate.substring(1, strPubDate.length() - 1);
