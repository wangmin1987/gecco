...
@Service
public class TenxunJsonListDynamicPipeline extends JsonPipeline {
	@Autowired
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(TenxunJsonListDynamicPipeline.class);
	@Override
