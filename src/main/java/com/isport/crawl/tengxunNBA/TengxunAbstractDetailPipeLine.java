 ...
 *
 */
public abstract class TengxunAbstractDetailPipeLine extends JsonPipeline {
	// mongo 操作工具
	@Autowired
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(TengxunAbstractDetailPipeLine.class);
