 ...
 */
@Service
public class APKvideoFunCrawl extends APstractPyVideo {
	// 文本去重工具
	@Autowired
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(APKvideoFunCrawl.class);
	// mongo 操作工具
	@Autowired
	...
	public void crawl(String index_url) {
		...
		if (StringUtils.isNUll(index_url)) {
			index_url = "http://www.aipingke.com/video_list/2-----------1-.html";
		}
	...
	protected void setRequestParameters(NewsInfoBean newsInfoBean) {
		final String tag = "乒乓球  趣味 视频", authorId = "9ce24a8afeb94662a37fc1e5530bf864",
	...
	private String getPage(String url) {
		String nowPage = url.substring(47, url.length());
