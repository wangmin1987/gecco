...
@Service
public class SinaNBADetail extends SinaAbstractDetailPipeLine{
	private static final Logger LOGGER = LoggerFactory.getLogger(SinaNBADetail.class);
	...
	protected void setParseParameter(NewsInfoBean newsInfoBean, JSONObject jo) {
		...
		pubDate=pubDate.replaceFirst("年", "-").replaceFirst("月", "-").replaceFirst("日", "");
