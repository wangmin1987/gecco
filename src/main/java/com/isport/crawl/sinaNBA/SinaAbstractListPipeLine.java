 ...
 *
 */
public abstract class SinaAbstractListPipeLine extends JsonPipeline {
	@Autowired
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(SinaAbstractListPipeLine.class);
...
//					String strLastUpdateTime = newsService.getLastUpdateTime(sourceKey);
				...
				Object[] urlarray = urllist.toArray();
				List<Object> span= (List<Object>)jo.getJSONArray("newsSpanList");
				Object[] spanarray = span.toArray();
				for (int i = 0; i < spanarray.length; i++) {
					try {
						//时间数组
						Object obj = spanarray[i];
						Object urlobj =urlarray[i];
						...
						String docUrl = getNewsDocUrl(url, urlobj);
